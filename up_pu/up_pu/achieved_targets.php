...
if(isset($_GET['email'])){
  ...
  $sql="SELECT COUNT(*) as total FROM journal_paper_published WHERE email ='$f_email' ";
...
?>
 ...
 <?php
 $sql1="SELECT COUNT(*) as total FROM workshops_organized WHERE email ='$f_email' ";
 ...
 <?php
 $sql2="SELECT COUNT(*) as total FROM webinars_guest_lectures_conference_org WHERE email ='$f_email' ";
 ...
 <?php
 $sql3="SELECT COUNT(*) as total FROM guest_lectures_delivered WHERE email ='$f_email' ";
 ...
 <?php
 $sql4="SELECT COUNT(*) as total FROM patents WHERE email ='$f_email' ";
 ...
 <?php
 $sql5="SELECT COUNT(*) as total FROM book_chapter WHERE email ='$f_email' ";
 ...
 <?php
 $sql6="SELECT COUNT(*) as total FROM other_certifications_completed WHERE email ='$f_email' ";
