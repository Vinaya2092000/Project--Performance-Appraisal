                            ...
                            <img src="download.png"   alt="" style="width:50%"></div>
                                ...
                                <hr>
                                    <li>
                                        ...
                                        <span class=".text-muted">Name : Itachi Uchiha </span>
                                        <span class="text-dark float-right font-weight-medium"></span>
                                    </li>
                                    <li>
                                        
                                        <span class=".text-muted">Email :itachi20@gmail.com</span>
                                        <span class="text-dark float-right font-weight-medium"></span>
                                    </li>
                                    <li>
                                       
                                        <span class=".text-muted">Contact No :9876543233</span>
                                        <span class="text-dark float-right font-weight-medium"></span>
                                    </li>
                                    <li >
                                       
                                        <span class=".text-muted">Department :IST(information science and technology)</span>
                                        <span class="text-dark float-right font-weight-medium"></span>
                                    </li>
                                    <li >
                                       
                                        <span class=".text-muted">Designation : ADM</span>
                                        <span class="text-dark float-right font-weight-medium"></span>
                                    </li>
