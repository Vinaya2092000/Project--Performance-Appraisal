...
echo ($email);
  ...
  $result = mysqli_query($con,"SELECT * FROM workshops_webinars_attended where email='$email'");
...
<style>
  ...
  <section id="ctdetails" class="hoc container clear"> 
    ...
    <div class="sectiontitle">
                                <h4 class="card-title">Webinars Attended</h4>
...
?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $row["title_of_the_webi_workshop"]; ?></td>
