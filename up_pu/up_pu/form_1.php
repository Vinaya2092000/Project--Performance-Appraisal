...
if(isset($_POST['register']))
{
    ...
    $insert_c = "insert into details_of_journal_publications(id,email,branch,name_of_faculty,first_author,title_of_the_article,name_of_the_journal,type_of_thejournal,impact_actor_cimago_journal_ranking) values('$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9')";

    $run_c=mysqli_query($con,$insert_c);

      echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert(' Succesfully Submitted')
    window.location.href='form_1.php';
    </SCRIPT>");
        }
        else{
                                    ...
                                    <li>
                                        <div class="message-center notifications position-relative">
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                <div class="w-75 d-inline-block v-middle pl-2">
                                                    <h6 class="message-title mb-0 mt-1">Vincenzo Moretti</h6> <span
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details Of Journal Publications Planned</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <hr>
                                        <label for="">First/Second Authors:</label>
                                        ...
                                        <input type="text" class="form-control" name="9" minlength="1" maxlength="2" pattern="[0-9]{1-2}">
                                        <hr>
