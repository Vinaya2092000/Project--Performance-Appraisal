...
echo ($email);
  ...
  $result = mysqli_query($con,"SELECT * FROM webinars_guest_lectures_conference_org where email='$email'");
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        ...
                                        <th scope="col">Faculty Email</th>
                                            <th scope="col">Type of Conference:</th>
                                            <th scope="col">Title of the Webinar::</th>
...
?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $row["title_of_the_webi"]; ?></td>
