                            ...
                            <div class="card-body">
                                <form class="mt-4" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        <?php
                                    $sql="SELECT COUNT(*) as total FROM book_chapter WHERE id = '$id' ";
...
?>
                                        ...
                                        <label for="" >
                                        <a href="jpp1.php?id=<?php echo $id; ?>" style="color: black;"> Total Publication details:<?php echo $data['total'];?></a> 
...
?>
<br>
<label for="" >Author(api score):<?php //echo $data1['total'];
switch($data1['total']){
    case 1:
        echo 10;
        break;
...
?></label>
<br>
 <label for=""> No of Author papers pub:<?php
                                  echo  
                                  $data1['total'];?></label>
...
<?php 
 ...
 FROM book_chapter
 WHERE (id = '$id' )
 AND 	publication_details LIKE 'editor%'";
...
?>
<br>
<label for="">Editor(api score):<?php //echo $data2['total'];
switch($data2['total']){
    case 1:
        echo 5;
        break;
    ...
    echo 0;
                                    ...
                                    <label for=""> No of Editor papers pub:<?php
                                  echo  
                                  $data2['total'];?></label>
...
?><!-- footer -->
            ...
            <footer class="footer text-center">
                All Rights Reserved by Presidency University . Designed and Developed by group5
                   .
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
