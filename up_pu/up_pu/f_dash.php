            ...
            <nav class="navbar top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <h3 style="color: black;"><img src="https://presidencyuniversity.in/wp-content/uploads/elementor/thumbs/WhitePresidency-University-Logo_madhu_16-04-21-01-plwzbkxszu9pdx3ljyj28y38s2yhpwx7ezochdxyww.png" title="WhitePresidency-University-Logo_madhu_16-04-21-01.png" alt="WhitePresidency-University-Logo_madhu_16-04-21-01.png"/></h3>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="achieved_targets2.php" class="sidebar-link"><span
                                            class="hide-menu"> Achieved Targets
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="api_display.php" class="sidebar-link"><span
                                            class="hide-menu"> API Display
                                        </span></a>
                                </li>
                        ...
                        <li class="list-divider"></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="features_page2.php"
                                aria-expanded="false"><span
                                    class="hide-menu">view features</span></a></li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">WELCOME <?php echo $row["name"]; ?>!</h3>
                        <div class="d-flex align-items-center"
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html">Faculty Dashboard</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div  class="mt-2" >
                            <img src="profile/<?php echo $row["pro_image"]; ?>"   alt="" style="width:100%"></div>
                                <ul class="list-style-none mb-0" style="color:black;" >
                                    <li>
                                        <i class="fas fa-circle text-primary font-10 mr-2"></i>
                                        <span class="text-muted">Name :</span>
                                        <span class="text-dark float-right font-weight-medium"><?php echo $row["name"]; ?></span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-danger font-10 mr-2"></i>
                                        <span class="text-muted">Designation :</span>
                                        <span class="text-dark float-right font-weight-medium"><?php echo $row["curr_desg"]; ?></span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-cyan font-10 mr-2"></i>
                                        <span class="text-muted">Department : </span>
                                        <span class="text-dark float-right font-weight-medium"><?php echo $row["dept"]; ?></span>
                                    </li>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                             <b><h5 style="color:black;" class="card-title mb-4">Email Id : <?php echo $row["email"]; ?> </h5></b>  
                               <hr>
                               <h5 style="color:black;" class="card-title mb-4">Academic Qualification : <?php echo $row["acc_quali"]; ?> </h5>
                               <hr>
                               <h5 style="color:black;" class="card-title mb-4">Experience : <?php echo $row["exp"]; ?> </h5>
                               <hr>
                               <h5 style="color:black;" class="card-title mb-4">contact No : <?php echo $row["ph_num"]; ?> </h5>
                               <hr>
                               <h5 style="color:black;" class="card-title mb-4">Address : <?php echo $row["address"]; ?> </h5>
                               <hr>
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center text-muted" style="background-color:white;">
                All Rights Reserved by NAME. Designed and Developed by 
                   .
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
