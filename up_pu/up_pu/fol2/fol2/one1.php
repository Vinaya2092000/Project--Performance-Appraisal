...
echo ($email);
  ...
  $result = mysqli_query($con,"SELECT * FROM details_of_journal_publications where email='$email'");
...
<style>
  ...
  <section id="ctdetails" class="hoc container clear"> 
    ...
    <div class="sectiontitle">
                                <h4 class="card-title">Journal Paper Planned</h4>
...
?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $row["type_of_thejournal"]; ?></td>
