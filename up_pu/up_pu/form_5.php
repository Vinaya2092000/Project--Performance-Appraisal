...
if(isset($_POST['register']))
{
    ...
    $t6 = $_POST['6'];
    $t7 = $_POST['7'];
    $insert_c = "insert into workshops_organized(sl_no,email,title_of_the_workshop,resource_person_det,no_of_days,dates,no_participants) values('$t1',' $t2','$t3','$t4','$t5','$t6','$t7')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details of FDP/ Workshops Organized</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <hr >
                                        <label for="">Title of the FDP / Workshop:</label>
                                        ...
                                        <input type="text" class="form-control" name="5" minlength="1" maxlength="2" pattern="[0-9]{1-2}">
                                        <hr>
                                        ...
                                        <input type="text" class="form-control" name="7" pattern="[0-9]+">
                                        <hr>
