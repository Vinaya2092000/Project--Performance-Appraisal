...
if(isset($_POST['register']))
{
    ...
    $t4 = $_POST['4'];
    $t5 = $_POST['5'];
    $insert_c = "insert into book_chapter(id,email,det_book_chap,name_of_faculty,publication_details) values('$t1','$t2','$t3','$t4','$t5')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details of Book Chapter</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <hr >
                                        <label for="">Title and Details of the Book Chapter:</label>
                                        ...
                                        <hr>
                                        <label for="">Publication details ( Author / Editor ):</label>
                                        <br>
                                        <input type="radio" name="5" value ="Author"/>Author<br>
                                            <input type="radio" name="5" value ="Editor"/>Editor<br>
                                        <hr>
