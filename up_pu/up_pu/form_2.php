...
if(isset($_POST['register']))
{
    ...
    $insert_c ="insert into journal_paper_accepted(id,email,branch,name_of_faculty,first_author,title_of_the_article,name_of_the_journal,type_of_the_journal,date_of_ubmission,listed_n_ugc_care_scopus_index,impact_actor_cimago_journal_ranking) values('$t1',' $t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9','$t10','$t11')";

    $run_c=mysqli_query($con,$insert_c);

      echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert(' Succesfully Submitted')
    window.location.href='form_2.php';
    </SCRIPT>");
        }
        else{
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details Of Journal Paper Accepted</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <label>
                                        <input type="radio" name="8" value ="National"/>National<br><br>
                                        <input type="radio" name="8" value ="International"/>International<br>
                                        </label>
                                        <hr>
                                        <label for="">Date of Submission:</label>
                                        <input type="date" name="9" id="date" placeholder="dd-mm-yyyy" value="" min="2018-01-01" max="2030-12-31">>
                                        <hr>
