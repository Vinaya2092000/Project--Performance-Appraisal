...
if(isset($_POST['register']))
{
    ...
    $t6 = $_POST['6'];
    $t7 = $_POST['7'];
    $insert_c = "insert into awards_honours_received(id,email,name_of_faculty,title_of_the_award,name_of_the_awarding_body,date,orther_det) values('$t1','$t2','$t3','$t4','$t5','$t6','$t7')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details of Awards/ Honours Received</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <hr >
                                        <label for="">Name of the Faculty 
:</label>
                                        <input type="text" class="form-control" name="3" value="<?php echo $row["name"]; ?>" readonly>
                                        <hr>
                                        <label for="">Title of the Award/ Honour received:</label>
                                        <input type="text" class="form-control" name="4">
                                        <hr>
                                        <label for="">Name of the awarding Body:</label>
                                        <input type="text" class="form-control" name="5">
                                        <hr>
                                        <label for="">Date:</label>
                                        <input type="date" name="6" id="date" placeholder="dd-mm-yyyy" value="" min="2018-01-01" max="2030-12-31">
                                        <hr>
