            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Webinars/Conference Organized</h4>
                            ...
                            <div class="card-body">
                                <form class="mt-4" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        <?php
                                    $sql="SELECT COUNT(*) as total FROM webinars_guest_lectures_conference_org WHERE id = '$id' ";
...
?>
                                        ...
                                        <label for="" >
                                        <a href="jpp1.php?id=<?php echo $id; ?>" style="color: black;"> Total Webinars/Conference Organized:<?php echo $data['total'];?></a> 
