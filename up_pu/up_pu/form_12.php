...
if(isset($_POST['register']))
{
    ...
    $t6 = $_POST['6'];
    $t7 = $_POST['7'];
    $insert_c = "insert into workshops_webinars_attended (id,email,name_of_faculty,title_of_the_webi_workshop,no_of_days,date,organized_by) values('$t1','$t2','$t3','$t4','$t5','$t6','$t7')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details Of Workshops/FDP/Webinars Attended</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <hr>
                                        <label for="">Title of the Workshop/FDP/Webinar:</label>
