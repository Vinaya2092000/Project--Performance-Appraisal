...
if(isset($_POST['register']))
{
    ...
    $insert_c ="insert into journal_paper_accepted(id,email,branch,name_of_faculty,first_author,title_of_the_article,name_of_the_journal,type_of_thejournal,date_of_ubmission,listed_n_ugc_care_scopus_index,impact_actor_cimago_journal_ranking) values('$t1',' $t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9','$t10','$t11')";
