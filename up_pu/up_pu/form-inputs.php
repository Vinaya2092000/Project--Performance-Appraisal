...
if(isset($_POST['register']))
{
    ...
    $wrkshop = $_POST['2'];
    $guest_lec = $_POST['3'];
    $guest_lec_deli = $_POST['4'];
    $patents = $_POST['5'];
    $book_chaps = $_POST['6'];
    $course_certif = $_POST['7'];
    $fname=$_POST['8'];
    $insert_c = "insert into targets (email,jour_pub_plan,workshops,guest_lec_webi_con,guest_lec_deli,patents,book_chaps,course_certi) values('$fname','$jpp','$wrkshop','$guest_lec','$guest_lec_deli','$patents','$book_chaps','$course_certif')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">TARGET SETTING</h4>
                            ...
                            <div class="card-body">
                                <form class="mt-4" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <input type="text" class="form-control" name="8"  value="<?php echo $row["email"]; ?>">
                                        <hr >
                                        <label for="">NUMBER OF JOURNAL PUBLICATIONS PLANNED:</label>
                                        <input type="text" class="form-control" name="1">
                                        <hr >
                                        <label for="">NUMBER OF WORKSHOPS/ FDP TO BE ORGANIZED:</label>
                                        <input type="text" class="form-control" name="2">
                                        <hr>
                                        <label for="">NUMBER OF GUEST LECTURES/ WEBINARS/ CONFERENCES TO BE ORGANIZED:</label>
                                        <input type="text" class="form-control" name="3">
                                        <hr>
                                        <label for="">NUMBER OF GUEST LECTURES TO BE DELIVERED:</label>
                                        <input type="text" class="form-control" name="4">
                                        <hr>
                                        <label for="">NUMBER OF PATENTS:</label>
                                        <input type="text" class="form-control" name="5">
                                        <hr>
                                        <label for="">NUMBER OF BOOK CHAPTERS PLANNED:</label>
                                        <input type="text" class="form-control" name="6">
                                        <hr>
                                        <label for="">NUMBER OF NPTEL COURSES / COURSERA CERTIFICATIONS COMPLETED:</label>
