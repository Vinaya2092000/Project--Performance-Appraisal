...
if(isset($_POST['register']))
{
    ...
    $t4 = $_POST['4'];
    $t5 = $_POST['5'];
    $insert_c = "insert into patents(id,email,det_patents,name_of_faculty,status) values('$t1',' $t2','$t3','$t4','$t5')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details of Patents</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <hr >
                                        <label for="">Title and Details of the Patent:</label>
                                        ...
                                        <label for="">Status (Applied/ Published/ Under Examination/ Granted):</label>
                                        </br>
                                        <label>
                                            <input type="radio" name="5" value ="Applied"/>Applied<br><br>
                                            <input type="radio" name="5" value ="Published"/>Published<br><br>
                                            <input type="radio" name="5" value ="UnderExamination"/>Under Examination<br><br>
                                            <input type="radio" name="5" value ="Granted"/>Granted<br><br>
                                        </label>
                                        <hr>
