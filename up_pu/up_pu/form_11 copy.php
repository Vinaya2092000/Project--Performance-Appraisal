...
if(isset($_POST['register']))
{
    ...
    $t7 = $_POST['7'];
    $t8 =$_POST['8'];
    $insert_c = "insert into research_proposal_submitted (id,email,branch,name_of_the_scheme,det_funding_gency,name_of_faculty,grants_sought_for,status) values('$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8')";
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><span
                                    class="hide-menu">SET TARGET </span></a>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="grid" class="feather-icon"></i><span
                                    class="hide-menu"> VIEW TARGET </span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                            <li class="sidebar-item"><a href="table-basic.php" class="sidebar-link"><span
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details of Research Proposals Submitted</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <input type="text" class="form-control" name="2"  value="<?php echo $row["name"]; ?>" readonly>
                                        <hr >
                                        <label for="">ID:</label>
                                        ...
                                        <hr>
                                        <label for="">Name of the Scheme:</label>
                                        <input type="text" class="form-control" name="4">
                                        <hr>
                                        <label for="">Name and Detials of the Funding Agency:</label>
                                        <input type="text" class="form-control" name="5">
                                        <hr>
                                        <label for="">Name of the Faculty:</label>
                                        <input type="text" class="form-control" name="6" value="<?php echo $row["name"]; ?>" readonly>
                                        <hr>   <label for="">Grants Sought for(Rs.):</label>
                                        <input type="text" class="form-control" name="7">
                                        <hr>
                                        <label for="">Status (Fund Granted/ Under Process/ Not Granted):</label>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <input type="text" class="form-control" name="6" value="<?php echo $row["name"]; ?>" readonly>
                                        <hr>  
                                        <label for="">Grants Sought for(Rs.):</label>
                                        <input type="text" class="form-control" name="7">
                                        <hr>
                                        <label for="">Status (Fund Granted/ Under Process/ Not Granted):</label>
                                        <label>
                                            <input type="radio" name="8" value ="Fund Granted"/>Fund Granted<br><br>
                                            <input type="radio" name="8" value ="Under Process"/>Under Process<br><br>
                                            <input type="radio" name="8" value ="Not Granted"/>Not Granted<br>
                                        </label>
                                        <hr>
                                        <input  name="register" class="form-control" type="submit" style="color:black;">
