...
if(isset($_POST['register']))
{
    ...
    $t6 = $_POST['6'];
    $t7 = $_POST['7'];
    $insert_c = "insert into other_certifications_completed (id,email,name_of_faculty,title_of_the_course,course_offered_by,duration,score) values('$t1','$t2','$t3','$t4','$t5','$t6','$t7')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details Of Other certifications completed (NPTEL Courses/Coursera)</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <input type="text" class="form-control" name="3" value="<?php echo $row["name"]; ?>" readonly>
                                        <hr>
                                        <label for="">Title of the Course:</label>
                                        <input type="text" class="form-control" name="4">
                                        <hr>
                                        <label for="">Course Offered by:</label>
                                        ...
                                        <hr>
                                        <label for="">Score/ Grade/ Any other Recognition(1-10):</label>
                                        <input type="text" class="form-control" name="7" pattern="[0-9]" required>
                                        <hr>
