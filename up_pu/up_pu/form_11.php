...
if(isset($_POST['register']))
{
    ...
    $t7 = $_POST['7'];
    $t8 =$_POST['8'];
    $insert_c = "insert into research_proposal_planned (id,email,branch,name_of_the_scheme,det_funding_gency,name_of_faculty,grants_sought_for,status) values('$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details Of Research Proposal Planned </h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <hr>
                                        <label for="">Name and Details of the Funding Agency:</label>
                                        ...
                                        <label>
                                            ...
                                            <input type="radio" name="8" value ="Not Granted"/>Not Granted<br><br>
                                        </label>
                                        <hr>
