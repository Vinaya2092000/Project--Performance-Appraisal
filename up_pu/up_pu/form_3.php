...
if(isset($_POST['register']))
{
    ...
    $t11 =$_POST['11'];
    $t12 =$_POST['12'];
    $insert_c = "insert into journal_paper_published(id,email,branch,name_of_faculty,first_author,title_of_the_article,name_of_the_journal,type_of_the_journal,vol_month_year,listed_n_ugc_care_scopus_index,doi_link_number,impact_actor_cimago_journal_ranking) values('$t1',' $t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9','$t10','$t11','$t12')";

    $run_c=mysqli_query($con,$insert_c);

      echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert(' Succesfully Submitted')
    window.location.href='form_3.php';
    </SCRIPT>");
        }
        else{
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details Of Journal Paper Published</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <label for="">Email:</label>
                                        <input type="text" class="form-control" name="2"  value="<?php echo $row["email"]; ?>" readonly>
                                        <hr >
                                        <label for="">ID.</label>
                                        <input type="text" class="form-control" name="1" value="<?php echo $row["id"]; ?>"readonly>
                                        <hr >
                                        <label for="">Branch:</label>
                                        <input type="text" class="form-control" name="3" value="<?php echo $row["dept"]; ?>"readonly>
                                        <hr>
                                        <label for="">Name Of Faculty:</label>
                                        <input type="text" class="form-control" name="4" value="<?php echo $row["name"]; ?>"readonly>
                                        <hr>
                                        <label for="">First Author/ Second Author/ Others:</label>
                                        <input type="text" class="form-control" name="5">
                                        <hr>
                                        <label for="">Title Of The Article:</label>
                                        <input type="text" class="form-control" name="6">
                                        <hr>
                                        <label for="">Name Of The Journal:</label>
                                        <input type="text" class="form-control" name="7">
                                        <hr>
                                        <label for="">Type of Journal(National/ International):</label>
                                        </br>
                                        <label>
                                            <input type="radio" class="control-input" name="8" value ="National"/>National<br><br>
                                            <input type="radio" class="control-input" name="8" value ="International"/>International<br>
                                        </label>
                                        <hr>
                                        <label for="">Vol., Month, Year, ISBN/ISSN No.:</label>
                                        <input type="text" class="form-control" name="9">
                                        <hr>
                                        <label for="">Listed in UGC Care/Scopus index/IEE/ABCD :</label>
                                        <input type="text" class="form-control" name="10">
                                        <hr>
                                        <label for="">DOI link/Number:</label>
                                        <input type="text" class="form-control" name="11">
                                        <hr>
                                        <label for="">Impact Factor/ Scimago Journal Ranking(1-10):</label>
