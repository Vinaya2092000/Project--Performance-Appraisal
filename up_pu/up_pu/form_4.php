...
if(isset($_POST['register']))
{
    ...
    $t9=$_POST['9'];
    $t10=$_POST['10'];
    $insert_c = "insert into papers_presented_in_conference(id,email,branch,name_of_faculty,title_of_the_conference,type_of_the_conference,details_of_the_organiser,title_of_the_paper,conference_dates,any_orther_conference_det) values('$t1',' $t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9','$t10')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details Of Papers Presented in Conference</h4>
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <label for="">Email:</label>
                                        ...
                                        <hr>
                                        <label for="">Title of the Conference:</label>
                                        <input type="text" class="form-control" name="5">
                                        <hr>
                                        <label for="">Type of Conference(National/ International):</label>
                                        <label>
                                            <input type="radio" name="6" value ="National"/>National<br>
                                            <input type="radio" name="6" value ="International"/>International<br>
                                        </label>
                                        <hr>
                                        ...
                                        <hr>
                                        <label for="">Any other Conference details:</label>
