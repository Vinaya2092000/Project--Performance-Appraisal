            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Journal Paper Published</h4>
...
?>
                                        ...
                                        <label for="" >
                                        <a href="jpp1.php?id=<?php echo $id; ?>" style="color: black;"> Total journal paper published:<?php echo $data['total'];?></a> 
 ...
 FROM  journal_paper_published
 WHERE (id = '$id' )
 AND type_of_the_journal LIKE 'international%'";
...
<?php 
 ...
 FROM  journal_paper_published
 WHERE (id = '$id' )
 AND type_of_the_journal LIKE 'national%'";
...
?>
<br>
<label for="">National(api score):<?php //echo $na;
$int=0;
  $int1 = 5;
switch($data2['total']){
    case 1:
