...
?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <!-- <h4 class="card-title">Journal Paper Published</h4> -->
                    <a href="jpp.php"> <h4 class="card-title">Journal Paper Published</h4></a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                <a href="ppc.php">      <h4 class="card-title">Paper Presented in Conference</h4></a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                <a href="co.php"><h4 class="card-title">Conference Organized</h4></a>    
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                <a href="bc.php"><h4 class="card-title">Book Chapters</h4></a>       
