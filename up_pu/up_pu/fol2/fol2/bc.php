...
?>
 ...
 FROM  book_chapter
 WHERE (id = '$id' )
 AND 	type_book_chapter LIKE 'international%'";
...
?>
<br>
<label for="" >International:<?php echo $data1['total'];?></label>
...
<?php 
 ...
 FROM book_chapter
 WHERE (id = '$id' )
 AND 	type_book_chapter LIKE 'national%'";
...
?>
<br>
<label for="">National:<?php echo $data2['total'];?></label>
