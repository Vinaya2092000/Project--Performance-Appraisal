...
if(isset($_POST['register']))
{
    ...
    $t6 = $_POST['6'];
    $t7 = $_POST['7'];
    $insert_c = "insert into webinars_guest_lectures_conference_org(id,email,type_of_the_conference,title_of_the_webi,resource_person_det,date,no_participants) values('$t1',' $t2','$t3','$t4','$t5','$t6','$t7')";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1" width="100%">Details Of Webinars/Guest Lectures/Conference Organized</h4 width="100%">
                            ...
                            <div class="card-body" >
                                <form class="mt-6" action="" method="POST">
                                    ...
                                    <div class="form-group"  >
                                        ...
                                        <label>
                                            <input type="radio" name="3" value ="National"/>National<br>
                                            <input type="radio" name="3" value ="International"/>International<br>
                                        </label>
                                        <hr>
                                        <label for="">Title of the Webinar:</label>
                                        <input type="text" class="form-control" name="4">
                                        <hr>
                                        <label for="">Name and Details of the Resource Person:</label>
