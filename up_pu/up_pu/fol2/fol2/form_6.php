...
if(isset($_POST['register']))
{
    ...
    $t6 = $_POST['6'];
    $t7 = $_POST['7'];
    $insert_c = "insert into webinars_guest_lectures_conference_org(id,email,title_of_the_conference,title_of_the_webi,resource_person_det,date,no_participants) values('$t1',' $t2','$t3','$t4','$t5','$t6','$t7')";
