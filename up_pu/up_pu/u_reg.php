...
<div class="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                  <div class="box" >
                    ...
                    <div class="inputBox">
                        <input type="text" name="username" placeholder="Username" pattern="[A-Za-z]+" required="true">
                        <label style="font-size:  1rem; color : white;">Enter Your Name</label>
                      </div>
                      <div class="inputBox">
                        <input type="text" name="fmname" placeholder="Parent Name" required="true">
                        <label style="font-size:  1rem; color : white;">Enter Father/Mother Name</label>
                      </div>
                      <div class="inputBox">
                        <input type="text" name="dept" placeholder="Department eg: IST" maxlength="10" pattern="[A-Za-z]+" required>
                        <label style="font-size:  1rem; color : white;">Department</label>
                      </div> 

                      <div class="inputBox">
                        <input type="text" name="cu" placeholder="Current Designation" pattern="[A-Za-z]+" required>
                        <label style="font-size:  1rem; color : white;">Current Designation</label>
                      </div>

                      <div class="inputBox">
                        <input type="text" name="aq" value="" placeholder="Qualifications" pattern="[A-Za-z]+" required="true">
                      ...
                      <div class="inputBox">
                        ...
                        <input type="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required="true">
                        <label>Password</label>
                      </div>
                      <div class="inputBox">
                        <input type="text" name="phonenumber" placeholder="Mobile Number" maxlength="10" pattern="[0-9]{10}" required="true">
                      ...
                      <div class="inputBox">
                        <input type="text" name="exp" placeholder="Experience" minlength="1" maxlength="2" pattern="[0-9]{1-2}" required="true">
